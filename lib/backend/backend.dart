...
/// Functions to query IdeasRecords (as a Stream and as a Future).
...
Future<List<IdeasRecord>> queryIdeasRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<IdeasRecord>> queryIdeasRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
